...
function Banner({trending}: Props) {
    ...
    const {setCurrentMovie, setShowModal} = useModal();
    ...
    return (
        <div>
            ...
            <span
                className="-ml-3 flex h-7 w-7 items-center justify-center rounded-full bg-[#2a28289d] md:-ml-4 md:h-9 md:w-9">
            ...
            <span
                className="-ml-3 flex h-7 w-7 items-center justify-center rounded-full bg-[#6a728253] md:-ml-5 md:h-9 md:w-9">
